  ...
  await Promise.all([
    prisma.homestay.upsert({
      ...
      create: {
        ...
        amenities: JSON.stringify(['WiFi', 'Air Conditioning', 'Kitchen', 'Parking']),
        featured: true,
        published: true,
      },
    }),
    prisma.homestay.upsert({
      ...
      create: {
        ...
        amenities: JSON.stringify(['WiFi', 'Mountain View', 'Garden', 'Breakfast Included']),
        featured: true,
        published: true,
      },
    }),
    prisma.homestay.upsert({
      ...
      create: {
        ...
        amenities: JSON.stringify(['WiFi', 'Terrace View', 'Kitchen', 'Hot Water']),
        featured: true,
        published: true,
      },
    }),
